...
>
> ```shell
> git worktree add ../ref-step-04 step-04-sensitive-disclosure
> cd ../ref-step-04/conference-mcp-server && ./mvnw quarkus:dev
> ```
>
...
> `git worktree remove ../ref-step-04`.
>
> To see only what this step changed:
> `git diff step-03-excessive-agency..step-04-sensitive-disclosure`
...
```shell
cd conference-assistant && ./mvnw test -Dtest=SensitiveDisclosureGuardTest,RoleFilteredRagAugmentorTest
```
