...
>
> ```shell
> git worktree add ../ref-step-02 step-02-token-propagation
> cd ../ref-step-02/conference-mcp-server && ./mvnw quarkus:dev
> ```
>
...
> `git worktree remove ../ref-step-02`.
>
> To see only what this step changed:
> `git diff step-01-prompt-injection..step-02-token-propagation`
...
Start the apps on `main` and log in as **alice**. Then send:
